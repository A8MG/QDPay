...
(function (Highcharts) {
    ...
    Highcharts.Chart.prototype.getCSV = function () {
        ...
        // Add header row
        csv = (xAxis.isDatetimeAxis ? 'DateTime' : '日期/交易额（单位：元）') + itemDelimiter +
    ...
    if (Highcharts.getOptions().exporting) {
        Highcharts.getOptions().exporting.buttons.contextButton.menuItems.splice(0, 0, {
            text: Highcharts.getOptions().lang.downloadCSV || '导出',
            onclick: function () {
                var a;
        ...
        Highcharts.getOptions().exporting.buttons.contextButton.menuItems.splice(1, 0, {separator: true});
    }
}(Highcharts));
